...
const Hero: React.FC = () => {
  return (
    <div
      className={`relative z-0 w-full overflow-hidden bg-opacity-75 bg-cover bg-[url('/bg_house.jpg')] ${poppins.className}`}
    >
      {/* Overlay */}
      ...
      <div className="z-50 m-auto mt-6 block w-[95%] items-center justify-between md:flex md:flex-row lg:w-[90%] xl:w-[1300px]">
        {/* Left Section */}
        <div className="h-fit w-full pt-8 md:w-1/2 md:py-12">
        ...
        <div className="relative mt-7 flex w-full items-end justify-center md:m-auto md:justify-end">
          <Image
            src={Cover}
            alt="Generative AI Certification Cover"
            className="md: ml-40 h-auto min-w-[900px] lg:w-[600px]"
            priority // Ensures optimized loading of the image
          />
        </div>
      </div>
    </div>
